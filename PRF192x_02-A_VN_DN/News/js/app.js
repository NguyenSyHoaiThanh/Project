$(document).ready(function () {
  const apiKey = "2f851f63c6f260f02b7ac5c4f19e457b";
        ...
        output += `
          ...
          <div class="card medium hoverable">
            ...
            <div class="card-content">
              ...
              <h6 class="truncate">Title:<a target="_blank" href="${latestNews[i].url}" title="${latestNews[i].title}">${latestNews[i].title}</a></h6>
